...
function cardAdd(cardData) { //cardData=parsed JSON
    var cardString = "<div class=\"smallcard\">"
    cardString += "<a target='_blank' href="+cardData.url+">"
    cardString+="<div class=\"cardbottom\">"
    cardString+= "<div class=\"cardtext\">"
    cardString+= "<h2> " + cardData.title + " </h2>"
    if (cardData.url != "") {
        cardString+= "</a>"
    }
